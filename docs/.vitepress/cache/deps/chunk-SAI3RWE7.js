  ...
  get attributes() {
    return Object.keys(this.attribs).map((name) => {
      ...
      return {
        ...
        namespace: (_a22 = this["x-attribsNamespace"]) === null || _a22 === void 0 ? void 0 : _a22[name],
...
function getAttributeValue(elem, name) {
  var _a22;
  return (_a22 = elem.attribs) === null || _a22 === void 0 ? void 0 : _a22[name];
}
...
function prop(name, value) {
  ...
  if (typeof name === "string" && value === void 0) {
    ...
    switch (name) {
      ...
      case "href":
      case "src": {
        const prop2 = (_a22 = el.attribs) === null || _a22 === void 0 ? void 0 : _a22[name];
...
var attributeRules = {
  ...
  start(next2, data2, options) {
    ...
    return (elem) => {
      var _a22;
      return !!((_a22 = adapter.getAttributeValue(elem, name)) === null || _a22 === void 0 ? void 0 : _a22.startsWith(value)) && next2(elem);
    };
  },
    ...
    if (shouldIgnoreCase(data2, options)) {
      ...
      return (elem) => {
        var _a22;
        return ((_a22 = adapter.getAttributeValue(elem, name)) === null || _a22 === void 0 ? void 0 : _a22.substr(len).toLowerCase()) === value && next2(elem);
      };
    }
    return (elem) => {
      var _a22;
      return !!((_a22 = adapter.getAttributeValue(elem, name)) === null || _a22 === void 0 ? void 0 : _a22.endsWith(value)) && next2(elem);
    };
  },
  any(next2, data2, options) {
    ...
    return (elem) => {
      var _a22;
      return !!((_a22 = adapter.getAttributeValue(elem, name)) === null || _a22 === void 0 ? void 0 : _a22.includes(value)) && next2(elem);
    };
  },
...
function compilePseudoSelector(next2, selector, options, context, compileToken2) {
  ...
  const userPseudo = (_a22 = options.pseudos) === null || _a22 === void 0 ? void 0 : _a22[name];
...
var Parser = class {
  ...
  closeCurrentTag(isOpenImplied) {
    ...
    if (this.stack[0] === name) {
      (_b = (_a22 = this.cbs).onclosetag) === null || _b === void 0 ? void 0 : _b.call(_a22, name, !isOpenImplied);
      this.stack.shift();
    }
  }
  /** @internal */
...
function compile2(self) {
  ...
  Object.keys(self.__schemas__).forEach(function(name) {
    const val2 = self.__schemas__[name];
    if (val2 === null) {
      return;
    }
...
function Match(self, shift) {
  ...
  const text3 = self.__text_cache__.slice(start, end2);
...
//# sourceMappingURL=chunk-SAI3RWE7.js.map
