import{C as t,c as o,o as r,j as e,G as p,a,k as c}from"./chunks/framework.el1ynxUs.js";const m=`# /zj_humanoid
## /robot
### /robot_state
- decription
...
- type
  - Service
- srv
- demo`,h=JSON.parse('{"title":"ROS API 导图列表","description":"","frontmatter":{},"headers":[],"relativePath":"markmap_ros_api.md","filePath":"markmap_ros_api.md"}'),d={name:"markmap_ros_api.md"},v=Object.assign(d,{setup(_){const i=m;return(y,n)=>{const s=t("Markmap");return r(),o("div",null,[n[0]||(n[0]=e("h1",{id:"ros-api-导图列表",tabindex:"-1"},[a("ROS API 导图列表 "),e("a",{class:"header-anchor",href:"#ros-api-导图列表","aria-label":'Permalink to "ROS API 导图列表"'},"​")],-1)),p(s,{content:c(i)},null,8,["content"])])}}});export{h as __pageData,v as default};
