import{C as t,c as o,o as r,j as e,G as i,a as l,k as m}from"./chunks/framework.BA3lb9wp.js";const c=`# zj_humanoid
...
\`\`\`
`,_=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"markmap_message_type.md","filePath":"markmap_message_type.md"}'),g={name:"markmap_message_type.md"},p=Object.assign(g,{setup(f){const a=c;return(b,n)=>{const s=t("Markmap");return r(),o("div",null,[n[0]||(n[0]=e("h2",{id:"zj-humanoid数据结构",tabindex:"-1"},[l("zj_humanoid数据结构 "),e("a",{class:"header-anchor",href:"#zj-humanoid数据结构","aria-label":'Permalink to "zj_humanoid数据结构"'},"​")],-1)),i(s,{content:m(a)},null,8,["content"])])}}});export{_ as __pageData,p as default};
